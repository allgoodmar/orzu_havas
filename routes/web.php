...
use App\Http\Controllers\ANasiyaController;
...
Route::post('/send/telegram', [ActionController::class, 'telegram'])->name('telegram');
Route::post('/callback/telegram', [ActionController::class, 'callBackTelegram'])->name('callBackTelegram');
Route::get('/apply/finish', [ActionController::class, 'redirectToFinish'])->name('redirectToFinish');
Auth::routes();

Route::get('/news', [ANasiyaController::class, 'showFull'])->name('anasiyashowfull');
Route::get('/news/{id}', [ANasiyaController::class, 'showOne'])->name('anasiyashowone');
